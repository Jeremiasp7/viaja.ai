...
public class PlanSugestionService implements LlmStrategy {
    ...
    public PlanSugestionService(ChatClient.Builder chatClientBuilder, UserRepository userRepository, GenericPlanRepository genericPlanRepository) {
    ...
    public String generatePlanWithGenericPlan(UUID genericPlan) throws Exception {
        GenericPlanEntityAbstract plan = genericPlanRepository.findById(genericPlan)
