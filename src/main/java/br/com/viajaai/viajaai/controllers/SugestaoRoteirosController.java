...
public class SugestaoRoteirosController {
  ...
  public String gerarTextoPreferencias(@PathVariable UUID userId)
      throws UsuarioNaoEncontradoException {
    return service.gerarRoteiroPreferencias(userId);
  }

  @GetMapping("/planos/{travelPlanId}")
  public String gerarTextoTravelPlan(@PathVariable UUID travelPlanId)
      throws TravelPlanNaoEncontradoException {
