...
public class DestinationRecommendationService {
  ...
  public DestinationRecommendationService(
      DestinationRepository destinationRepository, ChatClient.Builder chatClientBuilder) {
    this.destinationRepository = destinationRepository;
    this.chatClient = chatClientBuilder.build();
  }

  public List<RecommendedDestinationDto> recommendForUser(
      UUID userId, RecommendDestinationRequestDto recommendDestinationRequestDto) {
  ...
  private String buildRecommendationPrompt(
      List<DestinationEntity> pastTravels, RecommendDestinationRequestDto request) {
  ...
  private String buildUserPromptContext(RecommendDestinationRequestDto request) {
    ...
    return "Pedido específico do usuário: \""
